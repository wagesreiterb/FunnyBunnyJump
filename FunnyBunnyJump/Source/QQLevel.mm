...
//    }
    ...
    //level completed
    //    if(balloonsLeft == 0 && _gameOverLevelPassed == NO && _reloadLevel == NO) {
...
//
//-(void)myCleanup:(ccTime)dt {
//    NSLog(@"####################################### QQLevel::myCleanup::tick");
//    [self myCleanUp];
//}
...
//            //[self myCleanup];
//            if(_gameOverLevelPassed) {
//                NSLog(@"----- _gameOverLevelPassed: %@", self);
//                
//                //[[CCDirector sharedDirector] pause];
//                [[GameState sharedInstance] unlockNextLevel];
//                
